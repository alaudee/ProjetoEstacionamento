...
public class JFCarro extends javax.swing.JFrame {
    ...
    private void btnIncluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIncluirMouseClicked
        ...
        carroBean.setPlaca(txtPlaca.getText());
        carroBean.setCor(txtCor.getText());
        carroBean.setDescricao(txtDescricao.getText());
        
        lblMensagem.setText(carroDAO.inserir(carroBean));
    ...
    private void btnPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisarMouseClicked
        ...
        listaCarro = carroDAO.listarTodos();
        ...
        for (CarroBean carroBean : listaCarro){
            tbm.addColumn(new String[1]);
            
            tblConsulta.setValueAt(carroBean.getPlaca(), i, 0);
            tblConsulta.setValueAt(carroBean.getCor(), i, 1);
            tblConsulta.setValueAt(carroBean.getDescricao(), i, 2);
            i++;
        }
    ...
    private void btnAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAlterarMouseClicked
        ...
        lblMensagem.setText(carroDAO.alterar(carroBean));
    ...
    private void btnExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExcluirMouseClicked
        ...
        int i = JOptionPane.showOptionDialog(null, "Deseja excluir esse veíuclo: "+txtPlaca.getText()+"?", "Exclusão", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes [0]);
        
        if (i == JOptionPane.YES_OPTION){
            lblMensagem.setText(carroDAO.excluir(carroBean));
        }
